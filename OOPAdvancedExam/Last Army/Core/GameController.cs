public class GameController : IGameContorller
{
    private IArmy army;
    ...
    //{
    //    return Output.GiveOutput(result, army, this.wareHouse, this.MissionControllerField.MissionQueue.Count);
    //}
    ...
    //    {
    //        this.WareHouse[ammunition.Name] = new List<Ammunition>();
    //        this.WareHouse[ammunition.Name].Add(ammunition);
    //    }
    //    else
    //    {
    //        this.WareHouse[ammunition.Name][0].Number += ammunition.Number;
    //    }
    //}
